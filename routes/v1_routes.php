...
Route::middleware('cors')->group(function () {
    ...
    Route::get('comptes', [CompteController::class, 'index'])->middleware(['auth:api', \App\Http\Middleware\AdminMiddleware::class, \App\Http\Middleware\AccountAccessMiddleware::class]);

    Route::patch('comptes/{identifiant}', [CompteController::class, 'update'])->middleware(['auth:api', \App\Http\Middleware\AdminMiddleware::class, 'logging', \App\Http\Middleware\AccountAccessMiddleware::class]);

    Route::delete('comptes/{compteId}', [CompteController::class, 'destroy'])->middleware(['auth:api', \App\Http\Middleware\AdminMiddleware::class, 'logging', \App\Http\Middleware\AccountAccessMiddleware::class]);

    Route::get('comptes/{numero}', [CompteController::class, 'show'])->middleware(['auth:api', \App\Http\Middleware\AdminMiddleware::class, \App\Http\Middleware\AccountAccessMiddleware::class]);
